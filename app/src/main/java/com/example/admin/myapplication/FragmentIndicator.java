...
public class FragmentIndicator extends LinearLayout implements OnClickListener{
    ...
    private View createIndicator(int stringResID, int stringColor,String textTag,
        ...
        view.setLayoutParams(new LinearLayout.LayoutParams(
                LayoutParams.WRAP_CONTENT,95,1));
    ...
    private void init() {
        ...
        mIndicators[0] = createIndicator(R.string.tab_contacts,COLOR_DARK,TAG_TEXT_0,
                TAG_ICON_0,R.drawable.icon_contacts_0);
        ...
        mIndicators[1] = createIndicator(R.string.tab_records,COLOR_DARK,TAG_TEXT_1,
                TAG_ICON_1,R.drawable.icon_list_0);
        ...
        mIndicators[2] = createIndicator(R.string.tab_dialing,COLOR_DARK,TAG_TEXT_2,
                TAG_ICON_2,R.drawable.icon_dialing_0);
    ...
    public static void setIndicator(int which) {
        ...
        switch(mCurIndicator) {
            case 0:
                ...
                prevIcon.setImageResource(R.drawable.icon_contacts_0);
                break;
            case 1:
                ...
                prevText.setTextColor(COLOR_DARK);
                prevIcon.setImageResource(R.drawable.icon_list_0);
                break;
            case 2:
                ...
                prevText.setTextColor(COLOR_DARK);
                prevIcon.setImageResource(R.drawable.icon_dialing_0);
                break;
        }
        ...
        switch(which) {
            case 0:
                ...
                curIcon.setImageResource(R.drawable.icon_contacts_1);
                break;
            case 1:
                ...
                curText.setTextColor(COLOR_WHITE);
                curIcon.setImageResource(R.drawable.icon_list_1);
                break;
            case 2:
                ...
                curText.setTextColor(COLOR_WHITE);
                curIcon.setImageResource(R.drawable.icon_dialing_1);
                break;
        }
        mCurIndicator = which;
    }
